...
public class SmoothCheckBox extends View implements Checkable {
    ...
    private static final int COLOR_UNCHECKED =Color.parseColor("#D0D6CD");
    private static final int COLOR_CHECKED   = Color.parseColor("#FA700D");
    private static final int COLOR_FLOOR_UNCHECKED = Color.parseColor("#FA700D");
