...
public class Add_child_first_time extends AppCompatActivity  {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        save_data = new SaveData(Add_child_first_time.this);
        objUsefullData = new UsefullData(Add_child_first_time.this);
...
//                onBackPressed();
                Intent intent = new Intent(Add_child_first_time.this, App_startup.class);
        ...
        bod.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                DatePickerDialog dialog = new DatePickerDialog(Add_child_first_time.this,
   ...
   submit.setOnClickListener(new View.OnClickListener() {
       ...
       public void onClick(View view) {
           ...
           if (cancel==false) {
               ...
               objUsefullData.make_toast("Please check your field.");
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Ask.on(Add_child_first_time.this).forPermissions(Manifest.permission.CAMERA
    ...
    protected void onDestroy() {
        ...
        Intent intent = new Intent(Add_child_first_time.this, Tab_activity.class);
        intent.setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK);
        startActivity(intent);
        super.onDestroy();
    }
    ...
    private void selectImage(final CharSequence[] items) {
        i++;
        AlertDialog.Builder builder = new AlertDialog.Builder(Add_child_first_time.this);
        ...
        builder.setItems(items, new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int item) {
                if (items[item].equals("Take Photo")) {
                    ...
                    new PickerBuilder(Add_child_first_time.this, PickerBuilder.SELECT_FROM_CAMERA)
                    ...
                    new PickerBuilder(Add_child_first_time.this, PickerBuilder.SELECT_FROM_GALLERY)
                            .setOnImageReceivedListener(new PickerBuilder.onImageReceivedListener() {
                                @Override
                                public void onImageReceived(Uri imageUri) {
            ...
            UserAPI.post_JsonResp("/children", request, headers, null,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            objUsefullData.firebase_analytics("childAdd");
    ...
    private void oper_relations(ArrayList<String> s) {
        ...
        final Dialog dialog = new Dialog(Add_child_first_time.this);
        ...
        ArrayAdapter<String> adapter = new ArrayAdapter<String>(
                Add_child_first_time.this, R.layout.list_category, R.id.textCat,
                s);
